    ...
    <div class="managemerchant_container">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-white m-0 p-0">
                        <li class="breadcrumb-item">
                            <router-link :to="{ name: 'merchantcustomer.index' }">Home</router-link>
                        </li>
        ...
        <div class="" v-if="this.action=='view'">
                 ...
                 <div class="card-body px-0">
                          ...
                          <div class="col-md-4">
                             <div class="form-group row" :class="{ 'form-group--error': $v.mobileNumber.$error }">
                                ...
                                <div class="col-sm-6">
                                     ...
                                     v-model.trim="$v.mobileNumber.$model" readonly>
                                </div>
                         ...
                         <div class="col-md-4">
                           ...
                           <div class="col-md-4">
                             <div class="form-group row" :class="{ 'form-group--error': $v.organisationType.$error }">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control"
                                     v-model.trim="$v.organisationType.$model" readonly>
                                </div>
                     ...
                     <div class="row">
                          ...
                          <div class="col-md-4">
                             <div class="form-group row" :class="{ 'form-group--error': $v.yearOfIncorporation.$error }">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control"
                                     v-model.trim="$v.yearOfIncorporation.$model" readonly>
                                </div>
                        ...
                        <div class="col-md-4">
                             <div class="form-group row" :class="{ 'form-group--error': $v.organisationMobileNumber.$error }">
                                ...
                                <div class="col-sm-6">
                                     <input type="text" class="form-control"
                                     v-model.trim="$v.organisationMobileNumber.$model" readonly>
                                </div>
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-4">
                             <div class="form-group row" :class="{ 'form-group--error': $v.address.$error }">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control"
                                     v-model.trim="$v.address.$model" readonly>
                                </div>
                         ...
                         <div class="col-md-4">
                             <div class="form-group row"  :class="{ 'form-group--error': $v.addressLine2.$error }">
                                ...
                                <div class="col-sm-6">
                                   <input type="text" class="form-control"
                                     v-model.trim="$v.addressLine2.$model" readonly>
                                </div>
                     ...
                     <div class="row">
                           <div class="col-md-4">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" 
                                     v-model.trim="$v.postalcode.$model" readonly>
                                <div class="error col-sm-12 text-right" v-if="$v.postalcode.$error && !$v.postalcode.numeric">Please Enter Valid PostalCode</div>
                                <div class="error col-sm-12 text-right" v-if="$v.postalcode.$error && !$v.postalcode.maxLength">Maximum allowed length is 6 characters</div>
                          ...
                          <div class="col-md-4">
                             <div class="form-group row"  :class="{ 'form-group--error': $v.city.$error }">
                                ...
                                <div class="col-sm-6">
                                   <input type="text" class="form-control"
                                     v-model.trim="$v.city.$model" readonly>
                                </div>
                             ...
                             <div class="form-group row" :class="{ 'form-group--error': $v.country.$error }">
                                <label for="country" class="col-sm-6
                                    col-form-label text-right">Country</label>
                                <div class="col-sm-6">
                                   <input type="text" class="form-control"
                                     v-model.trim="$v.country.$model" readonly>
                                </div>
                                <div class="error col-sm-12 text-right" v-if="$v.country.$error && !$v.country.required">Please enter a country</div>
                              </div>
                         </div>
                         ...
                         <div class="col-md-4">
                             <div class="form-group row" :class="{ 'form-group--error': $v.stateName.$error }">
                                ...
                                <div class="col-sm-6">
                                   <input type="text" class="form-control"
                                     v-model.trim="$v.stateName.$model" readonly>
                                </div>
            ...
            <div class="d-flex mb-5">
              ...
              <!-- <button type="button" class="btn btn-success" @click="handleChangeSubscription">Change Subscription</button>-->
               <!--- <button type="button" class="btn btn-success" @click="handleChangePassword">Change Password</button>--->
            </div>
        </div>
...
export default {
  ...
  methods: {
    getMerchantinfo(partnerId) {
      ...
      this.$store.dispatch("merchant/get", partnerId).then(function(res) {
       //cachescope.myDebug(JSON.stringify(res));
        ...
        cachescope.yearOfIncorporation = res.yearOfIncorporation?moment(res.yearOfIncorporation, 'YYYY-MM-DD[T]HH:mm:ss.SSS[Z]').format("YYYY-MM-DD"):"";
        ...
        cachescope.subscriptionPlanId = res.subscriptionPlansDto.planName;
        cachescope.partnerId = res.partnerId;
        cachescope.status = res.status;

        cachescope.getCountryList(cachescope.countryCode);
    ...
    getCountryList(countryCode) {
      ...
      this.$store.dispatch("country/init").then(function(res) {
       //cachescope.myDebug(JSON.stringify(res));
        ...
        cachescope.isLoading = false;
        let countryObj = res.find(ele => ele.code == countryCode);
        cachescope.country = countryObj.name;
      }).catch(function(err){
        cachescope.$toast.open({
    ...
    handleChangeSubscription() {
      this.$router.push({ path: `/changesubscription` });
    },
    handleChangePassword() {
      this.$router.push({ path: `/changepassword` });
    },

    handleEdit: function(partnerId) {
      this.myDebug("Edit", partnerId);
      let path = `/completeprofile/?action=edit&merchant`;
