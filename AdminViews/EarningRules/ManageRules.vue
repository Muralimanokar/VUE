                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-white m-0 p-0">
                        <li class="breadcrumb-item">
                            <router-link :to="{ name: 'earningrule.index' , query: { 'templateid' : ruleTemplateId , 'partnerId' : partnerId }}">Earning Rules</router-link>
                        </li>
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-4">
                             <div class="form-group row" :class="{ 'form-group--error': $v.ruleTemplateId.$error }">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" v-model="$v.ruleTemplateId.$model" :disabled="action=='create'|| action == 'edit'">
                                        <option v-for="row in templateList" :value="row.id" v-bind:key="row.id">{{row.name}}</option>
                                    </select>
                                </div>
                                <div class="error col-sm-12 text-right" v-if="$v.ruleTemplateId.$error && !$v.ruleTemplateId.required">Please select a TemplateId</div>
                              </div>
                         </div>
                         <div class="col-md-4">
                             <div class="form-group row" :class="{ 'form-group--error': $v.category.$error }">
                                ...
                                <div class="error col-sm-12 text-right" v-if="$v.category.$error && !$v.category.required">Please select a category</div>
                              </div>
                     ...
                     <div class="row">
                         <div class="col-md-4">
                             <div class="form-group row" :class="{ 'form-group--error': $v.name.$error }">
                                ...
                                <div class="error col-sm-12 text-right" v-if="$v.name.$error && !$v.name.maxLength">Maximum allowed character is 100</div>
                                <div class="error col-sm-12 text-right" v-if="$v.name.$error && !$v.name.minLength">Minimum character is 6</div>
                              </div>
                                        ...
                                        <div class="row" v-if="row['name'] === 'GENERAL'">
                                             ...
                                             <div class="col-3">
                                                <div class="form-group row" style="margin-bottom:0px;" :class="{ 'form-group--error': !row['condition'].minimumOrderValue }">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="number" min="1" onkeyup="value=value.replace(/^(0+)|[^\d]+/g,'')" class="form-control" v-model="row['condition'].minimumOrderValue">
                                                    </div>
                                                </div>
                                             </div>
                                         </div>
                                             ...
                                             <div class="col-3">
                                                <div class="form-group row" style="margin-bottom:0px;" :class="{ 'form-group--error': !row['condition'].pointsValueToEarn }">
                                                    <label for="name" class="col-sm-6
                                                        ...
                                                        <!--<div class="col-sm-6">-->
                                                       <div class="col-sm-6" @change="handleInstantReward($event)">
                                         ...
                                         <div class="row" v-else-if="row['name'] === 'INSTANT_REWARD'">
                                             <div class="col-3">
                                                <div class="form-group row" style="margin-bottom:0px;" :class="{ 'form-group--error': !row['condition'].rewardType }">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select class="form-control"  v-model="row['condition'].rewardType" @change="handleInstantRewardchange($event)">
                                             ...
                                             <div class="col-3">
                                                <div class="form-group row" style="margin-bottom:0px;"  :class="{ 'form-group--error': !row['condition'].rewardname }">
                                                    <label for="name" class="col-sm-6
                                                        col-form-label text-right" style="padding-right: 5px;">Reward Name *</label>
                                                    <div class="col-sm-6">
                                     <select class="form-control" v-model="row['condition'].rewardname">
                                        <option value="null">Select</option>
                                        <option v-for="reward in rewardnameList" :value="reward" v-bind:key="reward.id">{{reward.name}}</option>
                                    </select>
                                                    </div>
                                                </div>
                                             </div>
                                         ...
                                         <div class="row" v-else-if="row['name'] === 'REFERRAL'">
                                             ...
                                             <div class="col-3">
                                                <div class="form-group row" style="margin-bottom:0px;">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="number" min="1" onkeyup="value=value.replace(/^(0+)|[^\d]+/g,'')" class="form-control" v-model="row['condition'].limitPerCustomer">
                                                    </div>
                                                </div>
                                             </div>
                                         </div>
                     ...
                     <div class="row">
                      ...
                      <!--  <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            ...
                            <div v-if="neverExpires != true" class="col-md-4" style="margin-left:-150px">
                             <div class="form-group row">
                                <label for="name" class="col-sm-6
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-4">
                             <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <div class="custom-control custom-switch"><!--:disabled="action=='create'"-->
...
import { required, requiredIf , minLength, between,helpers, regex, email , numeric , maxLength} from "vuelidate/lib/validators";
...
export default {
  ...
  /* rulecollection:{
      ...
      this.rewardnameList = [];
        ...
        this.getRewardValue(this.row['condition'].rewardType);
       },
       deep:true
  ...
  methods : {
      ...
      handlerule(){
          ...
          if(cacheScope.limit == "false"||cacheScope.limit==false||cacheScope.limit=="select")
          {

      cacheScope.Transactions=null;
              cacheScope.Value=null;
              cacheScope.Usage=null;
     $('#number').hide();
          $('#customer').hide();
     $('#value').hide();
          }
     ...
     $('#value').show();
      ...
      handleInstantRewardchange(event){
        //  console.log(JSON.stringify(this.rulecollection[0].condition.rewardType));
         // console.log(JSON.stringify(event.target.value))
          this.getRewardValue(event.target.value)
...
//console.log("djndjnjhdhkjsiuhkjdhkjkdniuhhkjdfhdjkjfnjdifhkjadefhkdhf",this.account);

       // console.log("Checkdata",cacheScope.account);

    },
    loadruledetails(ruleId){//work
         let cacheScope = this;
         let dataobj={
             ruleId: this.ruleId,
         ...
         this.$store.dispatch("earningrule/getRule",dataobj).then(function(res) {
           ...
           //  console.log(res);
             ...
             //console.log("123",cacheScope.limit)
            
              cacheScope.handlerule();
              
             //console.log("checkvalue",res.totalTransactionValue)
            ...
            if(res.startDate>=DateCheck.toISOString().slice(0, 10)){
             ...
             for(var i=0;i<TierData.length;i++){
              ...
              name: TierData[i].name,
                ...
                }else if(ele.ruleAttachType == "SEGMENT"){
                     console.log("check Segment",cacheScope.tierList);
          ...
          for(var i=0;i<res.productIdentifierDtoList.length;i++){
             ...
             let rule = {
               ...
               condition : JSON.parse(res.ruleDefinition)
                   ...
                   // console.log("check data1234",rule)
  ...
  handleInstantReward(event){
    ...
    handleSumbit(){ 
         ...
         if(this.Transactions==""){
            ...
            if(cacheScope.limit == false || cacheScope.limit== "false")
            {
              ...
              let dataobj = {
                ...
                "endDate": (this.endDate && !this.neverExpires)?this.getUTCDateFormat(this.endDate):"",
           ...
           let surll = `/rule/?templateid=${this.ruleTemplateId}&partnerid=${this.partnerId}`;
           ...
           /*for (var key of Object.keys(dataobj)) {
            ...
            axios.post( surl , formobj, {
              ...
              //  console.log("response",res);
                ...
                cacheScope.$router.push({ path: surll});
                 
               // cacheScope.$router.push({ path: `/rule` });
            })
                      .catch(function (err) {
                          cacheScope.isLoading = false;
           ...
           //  window.location.reload();
            ...
            cacheScope.$router.push({ path: `/managerules` });
          });
         }
      },
      ...
      loadtemplatelist(){
        let cacheScope = this;
         this.$store.dispatch("earningrule/earningrulelistAdmin").then(function(res) {
            cacheScope.templateList = res.data;
         });
      },
      loadtierlist(){
        let cacheScope = this;
        cacheScope.$store.dispatch("tiers/initActive",this.partnerId).then(function(res) {
    ...
    getRewardValue(name) {
      ...
      let storeAction = "reward/rewardValue";
      let param = {
        type: name,
      };
     // console.log("check")
      this.$store.dispatch(storeAction, param).then(function(res) {
       ...
       /* cachescope.rewardnameList=[];
        let abc={}
        abc.id=res.data[0].id
        abc.name=res.data[0].rewardType
        cachescope.rewardnameList.push(abc);
        console.log("check",abc);
        */
        cachescope.rewardnameList = [];
        res.data.forEach((reward) => {
          let ruleObj = {};
          ruleObj.id = reward.id;
          ruleObj.name = reward.rewardType;
          cachescope.rewardnameList.push(ruleObj);
        });
        cachescope.isLoading = false;
      }).catch(function(err){
        cachescope.$toast.open({
          message: "Reward value. Fetch Failed",
          type: "error",
          duration: 3000,
          dismissible: true,
          position: 'top'
      ...
      handleCancel(){
          let can = `/rule/?templateid=${this.ruleTemplateId}&partnerid=${this.partnerId}`;
          this.$router.push({ path: can });
